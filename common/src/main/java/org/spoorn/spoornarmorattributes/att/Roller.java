...
public class Roller {
    ...
    public static float rollThorns() {
        ThornsConfig config = ModConfig.get().thornsConfig;
        return SpoornArmorAttributesUtil.drawRandom(config.useGaussian, config.mean, config.standardDeviation, config.minReturnDmg, config.maxReturnDmg);
    }
}
