...
public class ExplosiveConfig {
    ...
    @Comment("Chance for an armor item to be Explosive [0 = never, 1 = always] [default = 0.02]\n" +
            "The explosion by default does not hurt other players.")
    public double attributeChance = 0.02;

    @Comment("Chance for each attack on the wearer to cause an explosion [0 = never, 1 = always] [default = 1.0]")
